...
var ASM_CONSTS = {
  527160: ($0, $1) => { var inp = document.getElementById('_desmos_eq_inp'); if (!inp) return; inp.style.top = $1 + 'px'; inp.value = UTF8ToString($0); var L = inp.value.length; inp.setSelectionRange(L, L); inp.focus(); window._desmosEqText = inp.value; window._desmosEqChanged = 0; },  
 527423: () => { var inp = document.getElementById('_desmos_eq_inp'); if (inp) { inp.style.top = '-200px'; inp.blur(); } window._desmosEqChanged = 0; },  
 527560: () => { return window._desmosEqChanged || 0; },  
 527601: () => { window._desmosEqChanged = 0; },  
 527634: () => { return window.innerWidth; },  
 527664: () => { return window.innerHeight; },  
 527695: () => { if (document.fullscreenElement) return 1; },  
 527741: () => { return Module.canvas.width; },  
 527773: () => { return parseInt(Module.canvas.style.width); },  
 527821: () => { document.exitFullscreen(); },  
 527848: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 527921: () => { if (document.fullscreenElement) return 1; },  
 527967: () => { return Module.canvas.width; },  
 527999: () => { return screen.width; },  
 528024: () => { document.exitFullscreen(); },  
 528051: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 528184: () => { return window.innerWidth; },  
 528210: () => { return window.innerHeight; },  
 528237: () => { if (document.fullscreenElement) return 1; },  
 528283: () => { return Module.canvas.width; },  
 528315: () => { return parseInt(Module.canvas.style.width); },  
 528363: () => { if (document.fullscreenElement) return 1; },  
 528409: () => { return Module.canvas.width; },  
 528441: () => { return screen.width; },  
 528466: () => { return window.innerWidth; },  
 528492: () => { return window.innerHeight; },  
 528519: () => { if (document.fullscreenElement) return 1; },  
 528565: () => { return Module.canvas.width; },  
 528597: () => { return screen.width; },  
 528622: () => { document.exitFullscreen(); },  
 528649: () => { if (document.fullscreenElement) return 1; },  
 528695: () => { return Module.canvas.width; },  
 528727: () => { return parseInt(Module.canvas.style.width); },  
 528775: () => { document.exitFullscreen(); },  
 528802: ($0) => { Module.canvas.style.opacity = $0; },  
 528840: () => { return screen.width; },  
 528865: () => { return screen.height; },  
 528891: () => { return window.screenX; },  
 528918: () => { return window.screenY; },  
 528945: () => { return window.devicePixelRatio; },  
 528981: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 529034: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 529085: () => { Module.canvas.style.cursor = 'none'; },  
 529122: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 529378: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 529429: () => { if (document.pointerLockElement) return 1; },  
 529476: () => { if (document.fullscreenElement) return 1; },  
 529522: () => { return window.innerWidth; },  
 529548: () => { return window.innerHeight; }
};
